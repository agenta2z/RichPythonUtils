...
included_input_path_keys = [
    ...
    "info_qa_get_answer_only.jsonl"
]

input_paths = list(
    filter(
        lambda input_path: any(included_input_path in input_path for included_input_path in included_input_path_keys),
        input_paths_all
    )
)
...
hprint_message(
    ...
    'included_input_path_keys', len(included_input_path_keys),
