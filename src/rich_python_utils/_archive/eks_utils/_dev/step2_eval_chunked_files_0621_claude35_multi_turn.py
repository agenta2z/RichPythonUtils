...
input_path_chunked_data = '/data/meta-reasoning-sandbox/data/evaluation_datasets/0501/test_sets_managed/source_data_chunked/chunk_3500-multiturn'
input_path_chunked_data = '/data/meta-reasoning-sandbox/data/evaluation_datasets/0501/test_sets_managed/source_data_chunked/chunk_1700-multiturn'
input_path_chunked_data = '/data/meta-reasoning-sandbox/data/evaluation_datasets/0501/test_sets_managed/source_data_chunked/chunk_500-multiturn'
input_path_chunked_data = '/data/meta-reasoning-sandbox/data/evaluation_datasets/0711/test_sets_managed/source_data_chunked/chunk_500-multiturn'
...
eval_type = 'multi_turn_0626_claude3'
eval_type = 'mt_pre0626_c35'
eval_type = 'mt_0626_c3h_r2'
eval_type = 'mt_0707_c3h_r7'
eval_type = 'mt_prod0711_c3h'
...
mr_configs = [
    'config_api_planning_verbose_multi_turn_only_jun26.yaml'
]

mr_configs = [
    'config_mt_claude3.yaml'
]

mr_configs = [
    'config_mt_claude3_haiku.yaml'
]

mr_configs = ['config_mt_claude3_haiku_0711_prod_with_fallback.yaml']

mr_configs = ['config_mt_claude3_haiku_0711_prod.yaml']


for config_index, mr_config_name in enumerate(mr_configs):
    for job_index, input_path in enumerate(input_paths):
