...
class BM25:
    ...
    def get_top_n_docs(self, query, documents, n=5):
        top_n = self.get_top_n_doc_indexes(query, documents, n)
...
class BM25Okapi(BM25):
    ...
    def get_scores(self, query):
        ...
        See [Trotman, A., X. Jia, M. Crane,
            Towards an Efficient and Effective Search Engine] for more info
        :param query:
        :return:
        """
    ...
    def get_batch_scores(self, query, doc_ids):
        """
        Calculate bm25 scores between request_second and subset of all docs
        """
