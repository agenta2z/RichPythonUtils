...
class GmailClient(EmailClientBase):
    ...
    scopes: List[str] = attrib(
        factory=lambda: ["https://www.googleapis.com/auth/gmail.modify"]
    )
    ...
    def search_threads_by_subject(self, subject_pattern: str) -> List[Dict[str, Any]]:
        """
    ...
    def get_messages_since(
        self, thread_id: str, since_timestamp: datetime
    ) -> List[Dict[str, Any]]:
        """
        ...
        filtered = [msg for msg in messages if msg["timestamp"] > since_timestamp]
