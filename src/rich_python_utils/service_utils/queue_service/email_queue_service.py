...
from ..email_utils.utils import extract_queue_id_from_subject, format_queue_subject
...
class EmailQueueService(QueueServiceBase):
    ...
    def _encode_operation(
        self, operation: str, queue_id: str, data: Optional[Any] = None
    ) -> str:
        """
    ...
    def _send_operation_email(
        self, queue_id: str, operation: str, data: Optional[Any] = None
    ) -> bool:
        """
    ...
    def create_queue(self, queue_id: str) -> bool:
        ...
        self._sync_states[queue_id] = SyncState(
            queue_id=queue_id, thread_id=thread_id, last_sync_time=datetime.now()
        )
    ...
    def _sync_queue(self, queue_id: str) -> int:
        ...
        for op in operations:
            try:
                ...
                print(
                    f"Warning: Failed to apply operation {op.get('operation_id')}: {e}"
                )
    ...
    def _apply_operation(self, operation: Dict[str, Any], queue_id: str) -> bool:
        """
