...
from rich_python_utils.console_utils.colorama_console_utils import (
    eprint as colorama_eprint,
    hprint as colorama_hprint,
    wprint as colorama_wprint,
)

colorama_hprint("This is `highlighted` text with white background", end="\n")
colorama_eprint(
    "This is `error highlighted` text with bright yellow background", end="\n"
)
...
from rich_python_utils.console_utils.rich_console_utils import (
    cprint,
    eprint as rich_eprint,
    hprint as rich_hprint,
    wprint as rich_wprint,
)
...
print("-" * 80)
cprint(
    "This has `cyan` highlights on `white` background", color="cyan", bk_color="white"
)
cprint(
    "This has `red` highlights on `bright_yellow` background",
    color="red",
    bk_color="bright_yellow",
)
cprint(
    "This has `green` highlights on `blue` background", color="green", bk_color="blue"
)
print()
...
print(
    f"HPRINT: highlight={HPRINT_HEADER_OR_HIGHLIGHT_COLOR}, background={HPRINT_MESSAGE_BODY_COLOR}"
)
print(
    f"EPRINT: highlight={EPRINT_HEADER_OR_HIGHLIGHT_COLOR}, background={EPRINT_MESSAGE_BODY_COLOR}"
)
print(
    f"WPRINT: highlight={WPRINT_HEADER_OR_HIGHLIGHT_COLOR}, background={WPRINT_MESSAGE_BODY_COLOR}"
)
print()
