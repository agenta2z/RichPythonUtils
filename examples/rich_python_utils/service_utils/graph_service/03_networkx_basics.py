    ...
    try:
        ...
        researcher_data = [
            (
                "alice",
                "Dr. Alice Chen",
                {"institution": "MIT", "department": "Physics", "h_index": 42},
            ),
            (
                "bob",
                "Dr. Bob Patel",
            ...
            (
                "carol",
                "Dr. Carol Kim",
                {"institution": "MIT", "department": "Climate Science", "h_index": 28},
            ),
            (
                "diana",
                "Dr. Diana Lee",
                {"institution": "Harvard", "department": "Genetics", "h_index": 51},
            ),
            (
                "eve",
                "Dr. Eve Zhang",
                {"institution": "Caltech", "department": "Materials", "h_index": 33},
            ),
        ]
        ...
        institution_data = [
            ...
            (
                "stanford",
                "Stanford University",
                {"location": "Stanford, CA", "ranking": 2},
            ),
            (
                "harvard",
                "Harvard University",
                {"location": "Cambridge, MA", "ranking": 3},
            ),
        ...
        alice_collab = svc.get_edges(
            "alice", edge_type="co_authored", direction="outgoing"
        )
        ...
        svc.add_node(
            GraphNode(
                ...
                node_type="researcher",
                label="Bob (Quantum)",
                properties={"role": "postdoc"},
            ),
            namespace="quantum_project",
        )
        svc.add_edge(
            GraphEdge(source_id="alice", target_id="bob", edge_type="supervises"),
            namespace="quantum_project",
        )
