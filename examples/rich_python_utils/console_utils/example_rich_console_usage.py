...
def demo_message_printing():
    ...
    cprint_message(
        "Success", "Green message", title_color="green", content_color="white"
    )
...
def demo_comparison_with_basics():
    ...
    console.print(
        "[cyan]basics.py (Colorama):[/cyan] Simple coloring, minimal dependencies"
    )
    console.print(
        "[cyan]rich_console_utils.py (Rich):[/cyan] Rich formatting, modern applications"
    )
...
if __name__ == "__main__":
    ...
    console.print(
        "[bold white on blue]"
        + " " * 22
        + "RICH CONSOLE UTILS USAGE EXAMPLES"
        + " " * 25
        + "[/]"
    )
